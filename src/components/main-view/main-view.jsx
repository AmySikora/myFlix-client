...
import { ProfileView } from "../profile-view/profile-view";  // Import the ProfileView
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route
          path="/profile"
          element={user ? <ProfileView user={user} /> : <Navigate to="/login" />} // Ensure ProfileView is included
        />
        <Route
          path="/"
